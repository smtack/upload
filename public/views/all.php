  ...
  <?php else: ?>
    <?php foreach($uploads as $upload): ?>
      <div class="upload-box">
        ...
        <h5>By <a href="<?php echo BASE_URL; ?>/profile?u=<?php echo escape($upload->user_username); ?>"><?php echo escape($upload->user_username); ?></a> &bull; <?php echo timeAgo(escape($upload->upload_date)); ?></h5>
