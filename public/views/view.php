    ...
    <?php else: ?>
      ...
      <?php foreach($comments as $comment): ?>
        <div class="comment">
          ...
          <span>By <a href="<?php echo BASE_URL; ?>/profile?user=<?php echo $comment->user_username; ?>"><?php echo $comment->user_name; ?></a> on <?php echo date('l j F Y \a\t H:i', strtotime($comment->comment_date)); ?></span>
        </div>
      <?php endforeach; ?>
    <?php endif; ?>
  </div>
